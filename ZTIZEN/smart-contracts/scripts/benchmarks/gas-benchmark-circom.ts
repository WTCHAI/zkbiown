...
// Commitment hash: keccak256(abi.encode(pubSignals[1..128]))
// Derived from PLACEHOLDER_PUB_SIGNALS[1..128] — matches the enrollment auth_commit_stored.
// In production the oracle computes this from the real auth_commit[128] before registerCredential.
import { keccak256, encodeAbiParameters, parseAbiParameters } from "viem"
const COMMITMENT_HASH: Hex = keccak256(
  encodeAbiParameters(
    parseAbiParameters('uint256[128]'),
    [PLACEHOLDER_PUB_SIGNALS.slice(1).map(s => BigInt(s)) as unknown as readonly [bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint]]
  )
)
...
async function main() {
  ...
  const registerHash = await ztizen.write.registerCredential([
    ...
    1n,             // version
    COMMITMENT_HASH, // keccak256(abi.encode(auth_commit_stored[128])) — oracle-computed at enrollment
  ])
